...
from ku.cell_sim.simulation import CellCultureSimulation, SoftCellParameters, SoftCellSimulation, Vec3
...
class SoftCellSimulationTests(TestCaseBase):
    ...
    def test_cell_culture_defaults_to_warp_when_available(self):
        ...
        self.assertTrue(all(cell.simulation.backend_name.startswith("warp:") for cell in culture.cells))
